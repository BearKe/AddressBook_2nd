...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    KCAddDataViewController *adddatacontroller=[[KCAddDataViewController alloc]init];
    tabBarController.viewControllers=@[webChatController,contactController,adddatacontroller];
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"AddressBook_e"];
